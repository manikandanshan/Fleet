...
<form:form method="POST" class="form-vertical" modelAttribute="company">
	<form:input type="hidden" path="id" id="id" />
	<div class="form-group">
		<div>
			<br> <a href="<c:url value='/list/company' />">
		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<form:input type="text" path="companyType" class="form-control"
