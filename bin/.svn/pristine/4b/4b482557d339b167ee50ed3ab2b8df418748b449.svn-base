...
<form:form method="POST" class="form-vertical"
	modelAttribute="vehicleInsurance">
	<form:input type="hidden" path="id" id="id" />
	<div class="form-group">
		<div>
			<br> <a href="<c:url value='/list/vehicle-insurance' />">
		...
		<div class="row">
			<div class="col-md-2">
				...
				<form:input type="text" path="insurancePolicyNumber" class="form-control"
					id="insurancePolicyNumber" autocomplete="off" required="" />
				<form:errors path="insurancePolicyNumber" cssClass="error" />
			</div>
			<div class="col-md-2">
